...
# 加载预训练的分词器，用于文本编码
tokenizer = AutoTokenizer.from_pretrained("/Users/a1233/yiyan/code/Embracing-AI/AI-learn/AI-learn/gpt2/model/models--uer--gpt2-chinese-cluecorpussmall/snapshots/c2c0249d8a2731f269414cc3b22dff021f8e07a3")
# 加载预训练的模型，用于语言模型任务
model = AutoModelForCausalLM.from_pretrained("/Users/a1233/yiyan/code/Embracing-AI/AI-learn/AI-learn/gpt2/model/models--uer--gpt2-chinese-cluecorpussmall/snapshots/c2c0249d8a2731f269414cc3b22dff021f8e07a3")
...
def train():
    ...
    for epoch in range(EPOCH):  # 循环每一轮训练
        ...
        # 保存最后一轮模型参数
        torch.save(model.state_dict(), "/Users/a1233/yiyan/code/Embracing-AI/AI-learn/AI-learn/gpt2/params/net.pt")  # 保存模型参数到指定路径
        print("权重保存成功！")  # 打印成功信息
