...
# 数据集根目录
dataset_root = '/Users/a1233/yiyan/code/Embracing-AI/AI-learn/AI-learn/voice-wakeup/dataset/train'

# 新创建的目录用于存放划分后的数据集
new_dataset_root = '/Users/a1233/yiyan/code/Embracing-AI/AI-learn/AI-learn/voice-wakeup/dataset/split_dataset'
